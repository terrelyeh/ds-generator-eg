...
const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  // ── Other / System ───────────────────────────────────────────────────────
  {
    ...
    description: "API keys for Claude, GPT, and Gemini — powers translation, Ask answers, and RAG embeddings.",
...
const GROUPS: { key: "ask" | "other"; label: string }[] = [
  { key: "ask", label: "Ask / Knowledge" },
  { key: "other", label: "Other / System" },
];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Manage Ask &amp; knowledge, AI providers, translation, and access.
        </p>
      </div>
