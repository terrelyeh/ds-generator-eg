  ...
  return (
    <header className="sticky top-0 z-50 bg-engenius-blue text-white shadow-md">
      <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-4 px-6">
        {/* The logo and the product name are one lockup. The PNG's wordmark
            sits on its bottom edge, so a baseline row lines it up with the
            text, and 22px makes its cap height match the 20px wordmark's —
            centred and at 28px the two sat 8px apart and looked unbalanced. */}
