...
const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  },
  {
    ...
    group: "translation",
    // PM can reach Settings now (for the glossary) but not this page — it
    // gates on settings.edit_typography. A card that 403s on click is
    // worse than no card.
    roles: ["admin", "editor"],
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  {
    title: "AI Models",
    description: "Which OpenRouter models the translation and Ask pickers offer, and which is the default. Changing a model is a row here, not a deploy.",
