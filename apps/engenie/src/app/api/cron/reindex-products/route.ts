...
import { redactOldAskQuestions } from "@/lib/ask/record-ask";
...
export async function GET(request: Request) {
  ...
  // Rides on this daily job rather than a cron of its own — it is one UPDATE.
  // Ask question text is kept 90 days (migration 00060); the counts stay.
  await redactOldAskQuestions();
