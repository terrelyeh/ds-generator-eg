...
> **實機預覽**:HTML 版本(`public/docs/ask-chat-ux-spec.html`,部署後 `…/docs/ask-chat-ux-spec.html`)頂端內嵌了 `/demo/ask` 的實機畫面,可邊讀規範邊操作。Demo 線上位置:`https://engenie-eg.vercel.app/demo/ask`(需 demo 通行碼)。
...
| 行距 | 1.7 | 1.75 |
| 段落間距 | 12px | 20px(`my-5`)|
| 標題 | h1 17 / h2 15.5 / h3 14.5 | h1 21 / h2 18 / h3 16 |
| 清單 | `padding-left: 24px`、項目間距 5px、行距 1.65 | `pl-5`、`my-2`、行距 1.7 |
| 表格 | 13.5px,斑馬紋 | 13.5px,可橫向捲動 |
| 閱讀寬度上限 | `max-w-[46rem]` | 容器 `max-w-[720px]` |

> 字級基準（2026-06-09 微調）：對齊 Claude/ChatGPT 網頁的閱讀感，桌機 14px、demo 15px。調整時兩版**等比例**一起動，維持「行為共用、外觀分流但讀感一致」。
